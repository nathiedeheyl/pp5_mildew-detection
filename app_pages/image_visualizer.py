...
def image_visualizer_body():
    ...
    * Image Montage
    ...
    st.info("* This tool helps explore cherry leaf images and visualize patterns related to powdery mildew.")
    ...
    if st.checkbox("Image Montage"):
      ...
      # Get only real directories in validation folder and exclude hidden system files
      validation_dir = os.path.join(my_data_dir, "validation")
      labels = [d for d in os.listdir(validation_dir) if os.path.isdir(os.path.join(validation_dir, d))]
